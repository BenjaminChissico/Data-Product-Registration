...
class DataProductDetails:
    ...
    def whole_data_product_to_dict(self)->list[dict[str,str|list[str]]]:
        ...
        dp_data = self.to_dict()
        table_data = [table.to_dict() for table in self.data_product_detail_sample_data_table]
        column_data = [column.to_dict() for column in self.data_product_detail_sample_data_column]
